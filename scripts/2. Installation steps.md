...
- [Guidance2](http://wasabiapp.org/software/pagan/)  v2.02
  ...
  - [ ] raxml
    ...
    -  Now install guidance.
      ...
      ```
    - To make it executable everywhere :
     ```
           alias guidance="cd /home/ceglab8/workspace/phd/research/efficiency_of_RELAX/CYP8B1/tools/guidance.v2.02/www/Guidance/guidance.pl"
           nano .bashrc
           alias guidance="cd /home/ceglab8/workspace/phd/research/efficiency_of_RELAX/CYP8B1/tools/guidance.v2.02/www/Guidance/"
     ```
