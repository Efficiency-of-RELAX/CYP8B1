...
- Perform model testing on each alignment - Using github repository `modeltest` of ddarriba.
      ...
      modeltest-ng -i orf.fa_PRANK.aln -t ml -T raxml
      modeltest-ng -i orf.fa_MUSCLE.aln -t ml -T raxml
      modeltest-ng -i orf.fa_CLUSTALW.aln -t ml -T raxml
      modeltest-ng -i orf.fa_MAFFT.aln -t ml -T raxml
