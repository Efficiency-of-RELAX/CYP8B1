...
- Compare alignments to get AOS and MOS - Using `mumsa` from [msa.sbc.su.se](http://msa.sbc.su.se/)
  ...
  - Mumsa assess the quality of multiple sequence alignments using 2 types of scores :
    - AOS - Average Overlap Score - Determining alignment difficulty.
          - AOS score above 0.8 indicates good agreement among the input alignments -> can be trusted.
          - AOS score drops below 0.5 the sequences are very difficult to align -> have to be treated with care.
       
    - MOS - Multiple Overlap Score - Determining alignment quality.
