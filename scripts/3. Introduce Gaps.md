...
- Sort MSA files before comparing - Using github repository `seqkit` of shensei356.
  ...
  - Below : MSA after sorting.
   ...
   <div style="float: right; margin-left: 30px;"><img title="Logo by @gregcaporaso." style="float: right;margin-left: 30px;" src="https://drive.google.com/drive/u/0/my-drive" align=right height=250/></div>     
