...
- However to confirm check one of the output it made - `Seqs.Codes` 
  ...
  - Make sure no sequences are repeated.
        ...
        Use of uninitialized value $ref_seq_name in string eq at /home/ceglab8/workspace/phd/research/efficiency_of_RELAX/CYP8B1/tools/guidance.v2.02/www/Guidance/../Selecton/codonAlign.pm line 202.
